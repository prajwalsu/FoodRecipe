    ...
    return {
      dishes: [
        ...
        },
        {
          ...
          head: "Steps in maKing Dosa",
          productImage: require("@/assets/food/d.jpeg"),
        },
      ],
    };
  },
